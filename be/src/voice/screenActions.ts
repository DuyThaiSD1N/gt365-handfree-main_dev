import type { IntentCode, ScreenAction, ScreenId } from './types.js';
export const screenActions: ScreenAction[] = [
  ...
  },
  {
    ...
    nextScreen: 'radio',
    feedback: [
      'Để mình chuyển sang kênh đó cho bạn.',
      'Mình tìm kênh đó cho bạn nhé.',
      'Mình mở kênh đó cho bạn liền.',
    ],
  },
  {
    ...
    feedback: [
      ...
      'Mình dừng Nội dung số cho bạn rồi đó, cần nghe lại cứ bảo mình.',
  ...
  },
  {
    ...
    feedback: [
      'Mình tắt mic cho bạn rồi đấy, lần sau bạn cứ gọi "GT365 ơi" là mình nghe lại liền nhé.',
      'Mình đã tắt mic cho bạn ạ, khi nào cần bạn gọi tên mình một tiếng là mình nghe lại liền nha.',
    ],
    requiresConfirmation: true,
    confirmPrompt: [
      'Mình tắt mic cho bạn nhé? Sau đó bạn gọi "GT365 ơi" để mình nghe lại.',
  ...
  },
  {
    ...
    feedback: [
      'Mình dừng lại đây, lúc nào cần bạn chạm nút trợ lý một cái là mình bật lại liền.', // ✅ THÊM MỚI
