import type { CommandDefinition, IntentCode, ScreenId } from './types';
...
export const commands: CommandDefinition[] = [
  ...
  },
  {
    ...
    phrases: [
      ...
      'mở mục nội dung số',
      'vào mục nội dung số',
      // Cách gọi quen thuộc: "radio" (normalizer đã map các biến thể ASR
      // "ra đi ô", "ra điêu", "rađio"... về "radio")
      'vào radio',
      'xem radio',
      'mở mục radio',
      'vào mục radio',
  ...
  {
    // Priority cao hơn RADIO_PLAY — khi có từ "kênh" + tên → match trước
  ...
  },
  {
    ...
    phrases: [
      ...
      'mình xem danh sách kênh được chứ',
      ...
      // Chuyên mục
      'liệt kê chuyên mục',
      'liệt kê chuyên mục cho tôi',
      'danh sách chuyên mục',
      'có những chuyên mục nào',
      'chuyên mục nào có sẵn',
      'kể tên các chuyên mục',
    ],
    allowedScreens: 'all',
    dangerLevel: 'safe',
    priority: 9,
